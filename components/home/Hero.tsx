...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm Yuvateja Reddy.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          ...
          />
          <img
            className="sqD bottom-[-300px] transform rotate-45 opacity-50 -right-1/4 sm:right-[-20%] lg:bottom-[-310px] lg:right-[-120px] w-[400px]"
            style={{ animationDelay: "0.3s" }}
            src="/static/doodles/hero/tejar.svg"
          />
          <img
